 ...
 * @author Admin
 */
public class EditMedicament extends javax.swing.JFrame {
    
    
    /**
     * Creates new form EditMedicament
     */
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jPart, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jCount, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jCost, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jNaim, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jid)))
    ...
    private void jSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSaveActionPerformed
        final EditMedicament frame = this;
         String id = jid.getText();
         String naim = jNaim.getText();
         try{
             Integer.parseInt(naim);
         } catch(NumberFormatException e) {
             JOptionPane.showMessageDialog(frame, "Чёт не так...");
             return;
         }
         ...
         try{
             ...
             JOptionPane.showMessageDialog(frame, "Всё время чёт не так...");
             return;
         }
         String count = jCount.getText();
         String part = jPart.getText();
      
         if("".equals(id)||"".equals(naim)||"".equals(cost)||"".equals(count )||"".equals(part)){
         JOptionPane.showMessageDialog(frame, "Мало!");
         }
         else{
             try {
                 Client.sendMessagetoServer("Edit medicament");
                 String[] editMedicament = {id, naim, cost,count,part};
                 Client.sendMessagetoServer(editMedicament);                 
                 dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditMedicament.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditMedicament().setVisible(true);
            }
        });
    }
